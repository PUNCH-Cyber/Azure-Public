#!/usr/bin/env python3
'''
Log Generator based on seth-paxton syslog-generator (github)
Added: TCP Socket in syslog handler - AB
Usage: ./log_gen_002.py --host localhost --port 6514 --file sample_logs --count 10 --sleep 5
'''
...
"""
hostname = "log_generator"
domain_name = ".provtest"
...
#    syslog = SysLogHandler(address=(args.host, args.port)) # UDP SOCK_DGRAM
    syslog = SysLogHandler(address=(args.host, args.port),socktype=socket.SOCK_STREAM) # TCP SOCK_STREAM
